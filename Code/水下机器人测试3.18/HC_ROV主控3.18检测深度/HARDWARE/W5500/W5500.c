...
* 描述    : 中断线3中断服务函数(W5500 INT引脚中断服务函数) PA3
* 输入    : 无
* 输出    : 无
* 返回值  : 无
* 说明    : 无
...
void SPI_Configuration(void)
{
	...
	GPIO_SetBits(W5500_SCK_PORT,W5500_SCK | W5500_MISO | W5500_MOSI);
	...
	SPI_InitStructure.SPI_BaudRatePrescaler=SPI_BaudRatePrescaler_2;	// 原波特率预分频值为2
